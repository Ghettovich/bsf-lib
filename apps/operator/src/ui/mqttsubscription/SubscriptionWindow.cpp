...
void SubscriptionWindow::onUpdateStatus(QMqttSubscription::SubscriptionState state)
{
    switch (state) {
        case QMqttSubscription::Unsubscribed:
            ui->labelStatusDisplay->setText(QLatin1String("Unsubscribed"));
            break;
        case QMqttSubscription::SubscriptionPending:
            ui->labelStatusDisplay->setText(QLatin1String("Pending"));
            break;
        case QMqttSubscription::Subscribed:
            ui->labelStatusDisplay->setText(QLatin1String("Subscribed"));
            break;
        case QMqttSubscription::Error:
            ui->labelStatusDisplay->setText(QLatin1String("Error"));
            break;
        default:
            ui->labelStatusDisplay->setText(QLatin1String("--Unknown--"));
            break;
    }
}